...
function updateProgress(){
    ...
    // current = current + (target - current)*0.01; 위의 내용 풀이
    progressBar.style.width=current + '%';
    progressText.innerHTML=Math.floor(current) + '%';//Math.ceil올림 Math.floor()버림
    console.log(current)
    if (current > 99.9){
...
//<img src="">
 for(let i=0; i<frameCount + 100;i++){
